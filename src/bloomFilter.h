...
#ifndef MONEROSCI_BLOOMFILTER_H
#define MONEROSCI_BLOOMFILTER_H
...
class BloomFilter {
public:
    BloomFilter(unsigned int bitsPerElement = 64,
                unsigned int estimatedNumElements = 5000000,
